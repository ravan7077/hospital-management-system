...
<body>
      ...
      <div class="row">
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            while($row = mysqli_fetch_assoc($result)) {
                ...
                <button type='submit' name='submit_button' class='btn btn_red'>Approve</button>
                </form>
                </td>
            </tr>";
  ...
  <form method='post' action='approve.php'>
     <input type='hidden' name='aid' value='$aid'>
     <button type='submit' name='submit_button' class='btn btn_red'>Approve appointement</button>
 </form>
</div>
</div>
